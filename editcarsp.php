    ...
    <h4>ADD CARS</h4>
      ...
      <div class="jumbotron"><center>
            ...
            <?php
                      ...
                      $sql = "UPDATE cars SET  cars_plate = :plate , cars_name = :name , cars_model = :model , cars_color = :color ,
                      cars_make = :make , cars_doors = :doors , cars_fuel = :fuel , cars_gears = :gearbox , cars_seats = :seats ,
                      cars_type = :vtype , cars_power = :power , cars_price_day = :price , cars_desc = :descr
                      WHERE cars_id = :cid";
                      ...
                      oci_bind_by_name($stmt, ':descr', $_POST["des"] );
                      oci_execute($stmt);

             ?>

<p>Cars <?php echo " " . $cid . " " ;?> has been updated.</p>
    </center>
      </div>
    </div>
