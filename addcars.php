  ...
  <div id = "home" class="jumbotron">
    ...
    if (isset($_POST['btnSubmit'])) {
      if($_FILES["filUpload"]["name"] != "")
      {
        ...
        $sql2 = "select 'R'||to_char(car_seq.nextval-1,'FM000') from dual";
        $stid2 = oci_parse($objConnect, $sql2);
        oci_execute($stid2);
        ...
        $sql2 = "select 'R'||to_char(car_seq.currval-1,'FM000') from dual";
        $stid2 = oci_parse($objConnect, $sql2);
        oci_execute($stid2);
        $row2 = oci_fetch_row($stid2);
        $ai = $row2[0];
    ...
    ?>
    <div align="center"><img src="ViewImage.php?FilesID=<?php echo $ai;?>" height = "50%" width="50%"></div>
    <?php
      }
    }
    ...
    //	echo "Copy/Upload is not Complete";
      ...
      ?>
      <img src="ViewImage.php?FilesID=<?php echo $ab;?>">
      <?php
    }else {
      $c = 3;
    }
...
<form action="addcarsp.php" method="post">
...
<td width="24%">
  <div align="center">
    <input name="plate" type="text" id="plate" size="20" maxlength="40" required/>
  </div></td>
<td width="29%"><div align="center">Name</div></td>
<td width="40%"><input name="name" type="text" id="name" size="40" maxlength="40" required/></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<td><div align="center">
  <input name="model" type="text" id="model" size="20" maxlength="40" required/>
</div></td>
...
<td><div align="center">
  <input name="make" type="text" id="make" size="20" maxlength="40" required/>
</div></td>
<td><div align="center">Doors</div></td>
<td><select name="doors" id="doors" required>
  <option value="">Choose ..</option>
  <option>2</option>
  <option>3</option>
  <option>4</option>
...
<td><select name="gearbox" id="gearbox" required>
  <option value="">Choose ..</option>
...
<td><select name="seats" id="seats" required>
  <option value="">Choose ..</option>
  <option>2</option>
  <option>3</option>
  <option>4</option>
...
<td><select name="vtype" id="vtype" required>
  <option value="">Choose ..</option>
...
<td><input name="power" type="number" id="power" size="10" maxlength="40" required/></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<h4>Description</h4>
<textarea name="descr" cols="93" rows="5"></textarea>
<br />
<br /><p align="right">
