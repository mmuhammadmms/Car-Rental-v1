...
.dropdown-menu li a:hover {
  ...
  if (isset($_POST['rent'])) {
    ...
    $sql = "UPDATE reservation SET  payment_status = 'Completed' WHERE RESERVATION_ID = '$rent'";
    ...
    echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Car rental is completed.');
    </SCRIPT>");
    ...
    <div class="col-sm-9">
            ...
            <?php
              ...
              $strSQL1 = "SELECT  ROW_NUMBER() OVER(ORDER BY RESERVATION_ID) AS ROWNO, T.* FROM RESERVATION T
                  WHERE (CUST_ID LIKE '%".$strKeyword."%'  ) AND PAYMENT_STATUS = 'Rented' OR PAYMENT_STATUS = 'Paid'";
            ...
            <table class="table table-striped table-hover table-bordered" >
              ...
              <button class="btn" type="submit" name="pick" value="<?php echo $objResult['RESERVATION_ID'];?>">Return Car</button></form></th>
            ...
            <?php
                ...
                if (isset($_POST['pick'])) {
                  ...
                  include ('connect.php');
                  $pick = $_POST['pick'];
                  $strSQL2 = "SELECT R.RESERVATION_ID , C.CARS_ID , C.CARS_NAME , CU.CUST_FNAME , CU.CUST_LNAME , R.RETURN_LOCATION , R.RETURN_DATE , R.RETURN_TIME , R.RENTAL_DURATION , R.RENTAL_PRICE
                ...
                <div class="container-fluid">
                  <div class="row content">
                    ...
                    <div class="col-sm-6">
                                  ...
                                  <div align="center"><form method="post" action=""><button class="btn" type="submit" name="rent" value="<?php echo $objResult2[0];?>">Return</button></form></div>
                            <h4>Details</h4>
                              ...
                              <table class="table table-striped">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    $pstatus = "";
                                    if ($row == 0){
                                      $pstatus = "<p id='Canceled'>Not Paid</p>";
                                    }else if ($row == 1){
                                      $pstatus = "<p id='Rented'>Deposit Paid</p>";
                                    }else {
                                      $pstatus = "<p id='Completed'>Full Rental Paid</p>";
                                    }
