  ...
  <li><a href="returncar.php">Return Car</a></li>
    ...
    <div class="col-sm-9">
            ...
            <div align="center">
              ...
              <option value="adusers.php">Staff</a></option>
              <option value="adusersc.php" selected="selected">Customer</a></option>
              </select>
      </div><br />
        </form>
            ...
            <?php
              include ("connect.php");
            	$strSQL1 = "SELECT  ROW_NUMBER() OVER(ORDER BY CUST_ID) AS ROWNO, T.* FROM CUSTOMER T
            			WHERE (CUST_FNAME LIKE '%".$strKeyword."%'  or CUST_EMAIL LIKE '%".$strKeyword."%' )  ";
            ...
            ?>
              <tr>
                ...
                <td><div align="center"><?php echo $objResult["CUST_FNAME"] . " " . $objResult["CUST_LNAME"];?></div></td>
                <td><div align="center"><?php echo $objResult["CUST_EMAIL"];?></div></td>
                <td><div align="center"><?php echo $objResult["CUST_REGDATE"];?></div></td>
                <td><center>
                <a href="editusers.php?cid=<?php echo $objResult["CUST_ID"];?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                <a href="delusers.php?cid=<?php echo $objResult["CUST_ID"];?>" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span></a>
              </center> </td>
              </tr>
            <?php
            }
