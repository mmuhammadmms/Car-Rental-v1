...
<div class="container-fluid">
  ...
  <li><a href="returncar.php">Return Car</a></li>
    ...
    <div class="col-sm-9">
            <h4>USERS</h4>
            <div align="">
            <a href="addusers.php" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add Users</a><br />
            </div>
            <br />
            <form>
            <div align="center">
              ...
              <option value="adusers.php" selected="selected">Staff</a></option>
              <option value="adusersc.php">Customer</a></option>
              </select>
            ...
            <?php
              include ("connect.php");
            	$strSQL1 = "SELECT  ROW_NUMBER() OVER(ORDER BY STAFF_ID) AS ROWNO, T.* FROM STAFF T
            			WHERE (STAFF_FNAME LIKE '%".$strKeyword."%'  or STAFF_EMAIL LIKE '%".$strKeyword."%' )  ";
              ...
              <tr>
                ...
                <th width="5%"> <div align="center">Registration Date </div></th>
            ...
            ?>
              <tr>
                <td><div align="center"><?php echo $objResult["STAFF_ID"];?></div></td>
                <td><div align="center"><?php echo $objResult["STAFF_FNAME"] . " " . $objResult["STAFF_LNAME"];?></div></td>
                <td><div align="center"><?php echo $objResult["STAFF_EMAIL"];?></div></td>
                <td><div align="center"><?php echo $objResult["STAFF_REGDATE"];?></div></td>
                <td><center>
                <a href="edituserss.php?cid=<?php echo $objResult["STAFF_ID"];?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                <a href="delusers.php?cid=<?php echo $objResult["STAFF_ID"];?>" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span></a>
              </center> </td>
              </tr>
            <?php
            }
