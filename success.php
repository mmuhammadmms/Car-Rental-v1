      ...
      <h4>Notice</h4>
        <div class="jumbotron"><center>
          ...
          if(!empty($txn_id) ){
                  ...
                  $sql = "INSERT INTO payments VALUES ( pay_seq.nextval , :it , :id ,:txn , :pg , :cd , :ps , sysdate , 'Deposit'  )";
                  ...
                  $sql2 = "UPDATE reservation SET payment_status = 'Confirmed' WHERE reservation_id = :it ";
          ...
          ?>
<p>Your deposit payment is successful.</p>
