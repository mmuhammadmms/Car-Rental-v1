  ...
  <li><a href="returncar.php">Return Car</a></li>
    ...
    <div class="col-sm-9">
                  ...
                  <div align="center">
                    ...
                    <option value="statistics3.php">Most Rent Customer</a></option>
                    </select>
            </div><br />
              ...
              <script>
                  ...
                  var barChartData = {
                      labels: ["Toyota Hiace", "BMW SD@$", "Mercedezz Benzzasdadasdasd" ,"Hilux tOyota" ,"c" ,"c" ,"c" ,"c" ,"c" ,"c" ,"c" ,"c" ,"c" ,],
                      datasets: [{
                          label: 'Total Rented',
                          backgroundColor: "rgba(46, 224, 165, 1)",
                          data: [1,2,3,3,3,3,3,3,3,3,3,3,3]
                      }]
