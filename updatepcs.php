      ...
      <div class="jumbotron"><center>
            ...
            <?php
                    $cid = $_GET['cid'];
                      ...
                      $sql = "UPDATE STAFF SET  STAFF_FNAME = :fname, STAFF_LNAME = :lname, STAFF_PASSWORD = :password
                      , STAFF_IC = :ic , STAFF_EMAIL = :email , STAFF_NUMBER = :cnumber , STAFF_COUNTRY =  :country , STAFF_CITY =  :city
                      , STAFF_STATE = :state , STAFF_POSCODE = :poscode , STAFF_ADDRESS = :address WHERE STAFF_USERNAME = :username";
...
<p><?php echo " " . $cid . " " ;?> profile has been updated.</p>
    </center>
      </div>
    </div>
