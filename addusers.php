...
<head>
  ...
  function validateForm() {
      var x = document.forms["add"]["pword"].value;
        var y = document.forms["add"]["pword2"].value;
...
<div class="container-fluid">
  ...
  <div id = "home" class="jumbotron">
    ...
    <form name="add" method="post" action="addusers2.php" onsubmit="return validateForm()">
      <div align="center">Role<select name="role" id="role">
