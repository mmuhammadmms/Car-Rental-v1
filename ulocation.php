...
<div class="container-fluid">
  ...
  <li><a href="profile.php">My Profile</a></li>
    ...
    <div class="col-sm-9">
      <h4>RENT CAR</h4><br />
          <div class="jumbotron">
            <form action="ulocation2.php" method="post">
          <h4>Choose Pickup Location</h4>
          <div align="center">
            <select name="location">
            <option value="<?php echo $objResult["PICKUP_LOCATION"];?>"><?php echo $objResult["PICKUP_LOCATION"];?></a></option>
    ...
    <div align="center"><br />
      <a href=""><button type="submit" class="btn2 btn-block">Search
