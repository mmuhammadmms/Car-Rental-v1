    ...
    <div class="col-sm-9">
            ...
            <table class="table table-striped table-hover table-bordered" >
              ...
              <tr>
                ...
                <th><center>
                  <a href="editreservation.php?rid=<?php echo $objResult["RESERVATION_ID"];?>" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span></a>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a id="Rented" class="dropdown-item" href="upreservstat.php?status=Approved&rid=<?php echo $objResult["RESERVATION_ID"];?>">Approved</a><br />
                      <a id="Canceled" class="dropdown-item" href="upreservstat.php?status=Disapproved&rid=<?php echo $objResult["RESERVATION_ID"];?>">Disapproved</a><br />
