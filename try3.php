...
<td width="24%">
  <div align="center">
    <input name="plate" type="text" id="plate" size="20" maxlength="40"/>
  </div></td>
<td width="29%"><div align="center">Name</div></td>
<td width="40%"><input name="name" type="text" id="name" size="40" maxlength="40" /></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<td><div align="center">
  <input name="make" type="text" id="make" size="20" maxlength="40" />
</div></td>
<td><div align="center">Doors</div></td>
<td><select name="doors" id="doors">
  <option>Choose ..</option>
  <option>2</option>
  <option>3</option>
  <option>4</option>
...
<td><input name="power" type="text" id="power" size="10" maxlength="40" /></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<h4>Description</h4>
<textarea name="descr" id="descr" cols="93" rows="5"></textarea>
<br />
<br /><p align="right">
