...
if (isset($_POST['search'])) {
  ...
  $lc = $_SESSION['location'];
  $strSQL = "SELECT * FROM cars where CARS_LOCATION = '$lc'";
  $objParse = oci_parse($conn, $strSQL);
  oci_execute ($objParse,OCI_DEFAULT);
}
            ...
            <form action="" method="post">
             <div class="container">
                ...
                <select name="type" id="type">
                  ...
                  <option value="Pickup Vehicle">Pickup Vechicle</option>
               ...
               <div class="row text-center">
                ...
                <div class="col-sm-4">
                  <div class="thumbnail">
                    <img src="ViewImage.php?FilesID=<?php echo $objResult["CARS_ID"];?>">
