...
<div class="container-fluid">
  ...
  <li><a href="returncar.php">Return Car</a></li>
    ...
    <div class="col-sm-9">
            ...
            include ("connect.php");
            $strSQL = "SELECT * FROM payments ORDER By PAYMENT_ID DESC";
            ...
            <?php
              include ("connect.php");
              $strSQL1 = "SELECT  ROW_NUMBER() OVER(ORDER BY PAYMENT_ID DESC) AS ROWNO, T.* FROM PAYMENTS T
                  WHERE (CUST_ID LIKE '%".$strKeyword."%'  ) ORDER BY PAYMENT_ID DESC ";
            ...
            <table class="table table-striped table-hover table-bordered" >
              ...
              <tr>
                ...
                <th><center><?php echo $objResult['PAYMENT_ID'];?></center></th>
                <th><center><?php echo $objResult['PAYMENT_DATE'];?></center></th>
                <th><center><p id="<?php echo $objResult['PAYMENT_TYPE'];?>"><?php echo $objResult['PAYMENT_TYPE'];?></p></center></th>
                <th><center>RM <?php echo $objResult['PAYMENT_GROSS'];?></center></th>
